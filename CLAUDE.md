...
1. **Tasks Hub** — GitLab issues/MRs + локальные задачи (SQLite), CRUD, фильтры.
2. **Health** — парсинг Apple Health export.xml, шаги/активность.
3. **Homelab Services** — статус сервисов (ping/HTTP healthcheck), из config.
