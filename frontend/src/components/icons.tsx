...
export const icons = {
  ...
  cpu: (p: IconProps) => (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" {...p}>
      ...
      />
      <path
        d="M10 1.5v3M14 1.5v3M10 19.5v3M14 19.5v3M1.5 10h3M1.5 14h3M19.5 10h3M19.5 14h3"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
  ...
  bot: (p: IconProps) => (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" {...p}>
      ...
      />
      <path
        d="M12 8V4M12 4h-2M9 13h.01M15 13h.01"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
  ...
  flame: (p: IconProps) => (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" {...p}>
      <path
        d="M12 3c1 3-2 4-2 7a2 2 0 104 0c2 1.5 3 3.5 3 6a5 5 0 11-10 0c0-3 2-4 2-7 1 1 2 1 3-6z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
  ...
  cloud: (p: IconProps) => (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" {...p}>
      <path
        d="M7 18a4 4 0 01-.5-7.97A6 6 0 0118 9.5a3.5 3.5 0 01-.5 8.5z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
