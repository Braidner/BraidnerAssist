...
const tabsTriggerVariants = cva(
  [
    ...
    "group-data-horizontal/tabs:after:left-2",
    "group-data-horizontal/tabs:after:right-2",
    "group-data-horizontal/tabs:after:bottom-[0px]",
    "group-data-horizontal/tabs:after:h-[2px]",
    "group-data-horizontal/tabs:after:rounded-t-sm",
    ...
    // show underline for both variants of active selector
